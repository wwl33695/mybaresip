...
static int print_handler_stdio(const char *p, size_t size, void *arg)
{
	(void)arg;
...
struct re_printf *re_get_stdio_printf()
{
	static struct re_printf pf = {print_handler_stdio, NULL};
